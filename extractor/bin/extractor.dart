...
Future<void> updateCountsFromUrl(List<int> counts, String url, HttpClient httpClient) async {
  final gitHubUrl = url
...
void updateCountsFromInclude(List<int> counts, String includePath) {
  var ruleSetIndex = -1;
  if (includePath.endsWith("core.yaml")) {
    ruleSetIndex = 0;
  } else if (includePath.endsWith("flutter.yaml")) {
    ruleSetIndex = 1;
  } else if (includePath.endsWith("recommended.yaml")) {
    ruleSetIndex = 2;
  }
